...
import com.mbj.compose_movieapp.ui.components.buttons.SecondaryBorderlessButton
import com.mbj.compose_movieapp.ui.components.buttons.SecondaryButton
import com.mbj.compose_movieapp.ui.components.buttons.UnderlinedTextButton
...
fun DialogButtonsColumn(
    ...
    Column(
        ...
        button?.forEachIndexed { index, dialogButton ->  
            if (index > 0) {
